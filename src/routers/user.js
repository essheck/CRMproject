...
router.get('/dashboard' , async function(req , res ) {
    ...
    let title = { title: "Dashboard"}
    res.render("dashboard.hbs" , {title: title , username : req.session.username , dashboardData: dashboardData})
    }catch(e){
        // console.log(e)
...
router.get('/customers' , async function(req , res){
    try{
        ...
        res.render("customers.hbs" , {title: "Customer" , msg: "Customer Found" , customers: customers , username : req.session.username})
